...
void got_packet(u_char *args, const struct pcap_pkthdr *header, const u_char *packet)
{
    ...
    /*
    after the above part that we save the ip in sock addr struct we tranlsate it to readble formt(we had to this like this and not to use the ip 
    from the ip struct because the func dont support this struct)
    */
